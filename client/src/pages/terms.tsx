...
import { Heading, Stack, Text, Box, List, ListItem } from '@chakra-ui/core';
import { TITLE_SHORT } from '../constants/site';

export default () => (
  <Box p={[2, 4]}>
    <Stack spacing={4}>
      <Heading size="2xl">利用規約</Heading>

      <Text>
        この利用規約（以下，「本規約」といいます。）は，{TITLE_SHORT}
        （以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </Text>

      <Heading size="md">第1条（適用）</Heading>
      <List ml={8} as="ol" styleType="decimal">
        <ListItem>
      ...
      <Heading size="md">第2条（利用登録）</Heading>
      <List ml={8} as="ol" styleType="decimal">
        <ListItem>
      ...
      <Heading size="md">第3条（ユーザーIDおよびパスワードの管理）</Heading>
      <List ml={8} as="ol" styleType="decimal">
        <ListItem>
      ...
      <Heading size="md">第4条（禁止事項）</Heading>
      ...
      <Heading size="md">第5条（本サービスの提供の停止等）</Heading>
      <List ml={8} as="ol" styleType="decimal">
        <ListItem>
      ...
      <Heading size="md">第6条（著作権）</Heading>
      <List ml={8} as="ol" styleType="decimal">
        <ListItem>
      ...
      <Heading size="md">第7条（利用制限および登録抹消）</Heading>
      <List ml={8} as="ol" styleType="decimal">
        <ListItem>
      ...
      <Heading size="md">第8条（退会）</Heading>
      <Text>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</Text>

      <Heading size="md">第9条（保証の否認および免責事項）</Heading>
      <List ml={8} as="ol" styleType="decimal">
        <ListItem>
      ...
      <Heading size="md">第10条（サービス内容の変更等）</Heading>
      <Text>
        当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。
      </Text>

      <Heading size="md">第11条（利用規約の変更）</Heading>
      <Text>
        当社は，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお，本規約の変更後，本サービスの利用を開始した場合には，当該ユーザーは変更後の規約に同意したものとみなします。
      </Text>

      <Heading size="md">第12条（個人情報の取扱い）</Heading>
      <Text>
        当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
      </Text>

      <Heading size="md">第13条（通知または連絡）</Heading>
      <Text>
        ユーザーと当社との間の通知または連絡は，当社の定める方法によって行うものとします。当社は,ユーザーから,当社が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
      </Text>

      <Heading size="md">第14条（権利義務の譲渡の禁止）</Heading>
      <Text>
        ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
      </Text>

      <Heading size="md">第15条（準拠法・裁判管轄）</Heading>
      <List ml={8} as="ol" styleType="decimal">
